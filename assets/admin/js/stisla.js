...
(function ($, window, i) {
    ...
    $.chatCtrl = function (element, chat, direction = 'top') {
        ...
        var person_group_chat = '';
          if (media_files!='') {
            var message_div ='<span class="msg_text_media" style="word-wrap: break-word; word-break: break-word; white-space: pre-wrap; max-width: 100%; display: inline-block;">' + person_group_chat +  media_files + '</span>';
        } else {
            var message_div ='<span class="msg_text_media" style="word-wrap: break-word; word-break: break-word; white-space: pre-wrap; max-width: 100%; display: inline-block;">' + person_group_chat + ' ' + chat.text + ' ' + media_files + '</span>';
        }
