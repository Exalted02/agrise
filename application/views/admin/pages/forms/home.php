            ...
            <div class="row">
                    ...
                    <div class="card card-style">
                        <div class="card-body">
                            <div class="media d-flex align-items-center justify-content-md-between">
                                <a class="align-self-center text-primary card-icon-div" href="<?= base_url('admin/orders/') ?>">
                                    <i class="ion-icon-cart4-outline display-4"></i>
                                </a>
                                <div class="media-body text-end <?= ($current_url == base_url('admin/orders')) ?>">
                                    <a href="<?= base_url('admin/orders/') ?>#order" class="text-muted text-bold-500 card-h5-style mx-2"> Orders </a>
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 col-12">
                    <div class="card card-style">
                        <div class="card-body">
                            <div class="media d-flex align-items-center justify-content-md-between">
                                <a class="align-self-center text-primary card-icon-div" href="<?= base_url('admin/system-users/') ?>">
                                    <i class="ion-ios-personadd-outline display-4"></i>
                                </a>
                                <div class="media-body text-end <?= ($current_url == base_url('admin/system-users')) ?>">
                                    <a href="<?= base_url('admin/system-users/') ?>" class="text-muted text-bold-500 card-h5-style mx-2"> New Sign Up </a>
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 col-12">
                    ...
                    <div class="card card-style">
                        <div class="card-body">
                            <div class="media d-flex align-items-center justify-content-md-between">
                                <a class="align-self-center text-primary card-icon-div" href="<?= base_url('admin/delivery-boys/manage-delivery-boy') ?>">
                                    <i class="ion-ios-people-outline display-4"></i>
                                </a>
                                <div class="media-body text-end <?= ($current_url == base_url('admin/system-users')) ?>">
                                    <a href="<?= base_url('admin/delivery-boys/manage-delivery-boy') ?>" class="text-muted text-bold-500 card-h5-style mx-2"> Delivery Boys</a>
                    ...
                    <div class="card card-style">
                        <div class="card-body">
                            <div class="media d-flex align-items-center justify justify-content-md-between">
                                <a class="align-self-center text-primary card-icon-div" href="<?= base_url('admin/product/') ?>">
                                    <i class="ion-ios-albums-outline display-4 display-4"></i>
                                </a>
                                <div class="media-body text-end <?= ($current_url == base_url('admin/system-users')) ?>">
                                    <a href="<?= base_url('admin/product/') ?>" class="text-muted text-bold-500 card-h5-style mx-2"> Products</a>
                ...
                <div class="gaps-1-5x row d-flex justify-content-center adjust-items-center mt-4">
                    <h5 class="col fw-bold ms-4 mb-0">Order Outlines</h5>
                    <div class="row col-12 d-flex">
                        ...
                        <div class="col-md-3">
                            <div class="card border border-secondary-secondary-secondary-secondary mt-4">
                                <div class="card-body  d-flex align-items-center justify-content-between order-outline-card">
                                    <div class="d-flex flex-column">
                                        <span class="fw-semibold d-block mb-1 col-md-12 h7">Return Request Pending</span>
                                        <h3 class="card-title mb-2 h8"><?= $status_counts['return_request_pending'] ?></h3>
                                    </div>
                                    <div class="d-flex flex-column justify-content-center rounded-circle bg-secondary circle">
                                        <i class="fa fa-xs fa-history link-color fa-lg d-flex justify-content-center text-white circle-icon"></i>
                                    </div>
