                ...
                <form class="form-horizontal form-submit-event" action="<?= base_url('admin/setting/update_system_settings') ?>" method="POST" id="system_setting_form" enctype="multipart/form-data">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="number" min="0" class="form-control mb-2" name="support_number" value="<?= (isset($settings['support_number'])) ? $settings['support_number'] : '' ?>" placeholder="Customer support mobile number - used in whole system" />
                                            </div>
                                            <div class="form-group col-md-6">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="number" min="1" class="form-control mb-2" name="low_stock_limit" value="<?= (isset($settings['low_stock_limit'])) ? $settings['low_stock_limit'] : '5' ?>" placeholder='Product low stock limit' />
                                            </div>
                                            <div class="form-group col-md-6">
                                            ...
                                            <div class="form-group col-md-6">
                                                <label class="mb-2" for="admin_store_state"> Admin Store State <span class='text-danger text-xs'>*</span></label>
                                                <textarea type="text" class="form-control mb-2" id="admin_store_state" placeholder="admin_store_state" name="admin_store_state"><?= isset($settings['admin_store_state']) ? output_escaping(str_replace('\r\n', '&#13;&#10;', $settings['admin_store_state'])) : ""; ?></textarea>
                                            </div>
                                            <div class="form-group col-md-6">
                                            ...
                                            <div class="form-group col-md-6 ">
                                                ...
                                                <input type="number" min="0" class="form-control mb-2" name="minimum_cart_amt" value="<?= (isset($settings['minimum_cart_amt'])) ? $settings['minimum_cart_amt'] : '' ?>" placeholder='Minimum Cart Amount' />
                                            </div>
                                            <div class="form-group col-md-6 ml-1">
                                                <label class="mb-2" for="max_items_cart"> Maximum Items Allowed In Cart <span class='text-danger text-xs'>*</span>
                                                </label>
                                                <input type="number" min="1" class="form-control mb-2" name="max_items_cart" value="<?= (isset($settings['max_items_cart'])) ? $settings['max_items_cart'] : '' ?>" placeholder='Maximum Items Allowed In Cart' />
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label class="mb-2" for="platform_fees">Platform Fees (<?= $currency ?>) <span class='text-danger text-xs'>*</span>
                                                </label>
                                                <input type="number" step="0.01" min="0" class="form-control mb-2" name="platform_fees" value="<?= (isset($settings['platform_fees'])) ? $settings['platform_fees'] : '0' ?>" placeholder='Platform Fees Amount' />
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label class="mb-2" for="min_cod_order_amount">Minimum COD Order Amount (<?= $currency ?>)</label>
                                                <input type="number" min="0" step="0.01" class="form-control mb-2" name="min_cod_order_amount" value="<?= (isset($settings['min_cod_order_amount'])) ? $settings['min_cod_order_amount'] : '' ?>" placeholder='Minimum Order Amount for COD' />
                                                <small class="text-muted">Leave empty for no minimum limit</small>
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label class="mb-2" for="max_cod_order_amount">Maximum COD Order Amount (<?= $currency ?>)</label>
                                                <input type="number" min="0" step="0.01" class="form-control mb-2" name="max_cod_order_amount" value="<?= (isset($settings['max_cod_order_amount'])) ? $settings['max_cod_order_amount'] : '' ?>" placeholder='Maximum Order Amount for COD' />
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-6 delivery_charge <?= $d_none ?>">
                                                ...
                                                <input type="number" min="0" class="form-control mb-2" name="delivery_charge" value="<?= (isset($settings['delivery_charge'])) ? $settings['delivery_charge'] : '' ?>" placeholder='Delivery Charge on Shopping' />
                                            </div>
                                            <div class="form-group col-md-6 min_amount <?= $d_none ?>">
                                                ...
                                                <input type="number" min="0" class="form-control mb-2" name="min_amount" value="<?= (isset($settings['min_amount'])) ? $settings['min_amount'] : ''  ?>" placeholder='Minimum Order Amount for Free Delivery' />
                                            </div>
                                            <div class="form-group col-md-6">
                                            ...
                                            <div class="form-group col-md-6 mt-5 d-flex justify-content-between">
                                                <label class="mb-2" for="is_delivery_boy_otp_setting_on"> Order Delivery OTP System</label>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-4 mt-3">
                                                ...
                                                <input type="number" min="0" step="0.1" name="min_refer_earn_order_amount" class="form-control mb-2" value="<?= (isset($settings['min_refer_earn_order_amount']) && $settings['min_refer_earn_order_amount'] != '') ? $settings['min_refer_earn_order_amount'] : ''  ?>" placeholder="Amount of order eligible for bonus" />
                                            </div>

                                            <div class="form-group col-md-4 mt-4">
                                                <label class="mb-2" for="refer_earn_bonus">Refer & Earn Bonus (<?= $currency ?> OR %)</label>
                                                <input type="number" min="0" step="0.1" class="form-control mb-2" name="refer_earn_bonus" value="<?= (isset($settings['refer_earn_bonus'])) ? $settings['refer_earn_bonus'] : '' ?>" placeholder='In amount or percentages' />
                                            </div>

                                            <div class="form-group col-md-4 mt-4">
                                                <label class="mb-2" for="max_refer_earn_amount">Maximum Refer & Earn Amount (<?= $currency ?>)</label>
                                                <input type="number" min="0" step="0.1" class="form-control mb-2" name="max_refer_earn_amount" value="<?= (isset($settings['max_refer_earn_amount'])) ? $settings['max_refer_earn_amount'] : '' ?>" placeholder='Maximum Refer & Earn Bonus Amount' />
                                            </div>

                                            <div class="form-group col-md-4 mt-4">
                                                <label class="mb-2" for="refer_earn_bonus_times">Number of times Bonus to be given to the customer</label>
                                                <input type="number" min="0" class="form-control mb-2" name="refer_earn_bonus_times" value="<?= (isset($settings['refer_earn_bonus_times'])) ? $settings['refer_earn_bonus_times'] : '' ?>" placeholder='No of times customer will get bonus' />
                                            </div>
                                ...
                                <div class="card card-body">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <a class="btn btn-xs btn-primary text-white h-fit" data-toggle="modal" data-target="#howItWorksModal1" title="How it works">How Promo Code Discount works?</a>
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-12">
                                                ...
                                                <a class="btn btn-xs btn-primary text-white mb-2" data-toggle="modal" data-target="#howItWorksModal1" title="How it works">Cron Job URL for Remaining Item in cart</a>
                                                <input type="text" class="form-control mt-1" name="app_name" value="<?= base_url('admin/cron_job/remaining_cart') ?>" disabled />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-md-12 mt-4">
                        <div class="row">
                            <div class="col-md-12 ">
                                <div class="card card-body">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            <label for="android_app_store_link">android App Store Link <span class='text-danger text-xs'>*</span></label>
                                            <input type="text" class="form-control mt-2" id="android_app_store_link" name="android_app_store_link" value="<?= (isset($settings['android_app_store_link'])) ? output_escaping($settings['android_app_store_link']) : '' ?>" placeholder="android App Store Link" />
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="ios_app_store_link">ios App Store Link<span class='text-danger text-xs'>*</span></label>
                                            <input type="text" class="form-control mt-2" id="ios_app_store_link" name="ios_app_store_link" value="<?= (isset($settings['ios_app_store_link'])) ? output_escaping($settings['ios_app_store_link']) : '' ?>" placeholder="ios App Store Link" />
                                        </div>
                                        <div class="form-group col-md-6 mt-3">
                                            <label for="scheme">Scheme For APP <span class='text-danger text-xs'>*</span></label>
                                            <input type="text" class="form-control mt-2" id="scheme" name="scheme" value="<?= (isset($settings['scheme'])) ? output_escaping($settings['scheme']) : '' ?>" placeholder="Scheme For APP" />
                                        </div>
                                        <div class="form-group col-md-6 mt-3">
                                            <label for="host">Host For APP<span class='text-danger text-xs'>*</span></label>
                                            <input type="text" class="form-control mt-2" id="host" name="host" value="<?= (isset($settings['host'])) ? output_escaping($settings['host']) : '' ?>" placeholder="Host For APP" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="card card-body">
                                            ...
                                            <div class="row">
                                                <div class="form-group col-md-12 d-flex justify-content-between">
                                                    ...
                                                    <a class=" form-switch  mr-1 mb-1" title="Deactivate" href="javascript:void(0)"> <input type="checkbox" class="form-check-input " role="switch" name="email_login" <?= (isset($settings['email_login']) && $settings['email_login'] == true) ? 'Checked' : ''  ?> /></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12 ">
                                        <div class="card card-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div>
                                                    <input type="number" min="0" class="form-control <?= (isset($settings['whatsapp_status']) && $settings['whatsapp_status'] == 1) ? '' : 'collapse'  ?>" name="whatsapp_number" id="whatapp_number_input" placeholder="Whatsapp Number" value="<?= isset($settings['whatsapp_number']) ? output_escaping(str_replace('\r\n', '&#13;&#10;', $settings['whatsapp_number'])) : ""; ?>">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="form-group col-md-12 d-flex justify-content-between">
                                                    ...
                                                    <a class="form-switch mr-1 mb-1" title="Deactivate" href="javascript:void(0)">
                                                        <input type="checkbox" class="form-check-input" id="pincode_wise_deliverability" role="switch" name="pincode_wise_deliverability" <?= (isset($settings['pincode_wise_deliverability']) && $settings['pincode_wise_deliverability'] == true) ? 'Checked' : '' ?> />
                                                    </a>
                                                </div>
                                                <div class="form-group col-md-12 d-flex justify-content-between">
                                                    ...
                                                    <a class="form-switch mr-1 mb-1" title="Deactivate" href="javascript:void(0)">
                                                        <input type="checkbox" class="form-check-input" id="city_wise_deliverability" role="switch" name="city_wise_deliverability" <?= (isset($settings['city_wise_deliverability']) && $settings['city_wise_deliverability'] == true) ? 'checked' : '' ?> <?= ($shipping_settings['shiprocket_shipping_method'] == 1) ? 'disabled' : '' ?> />
                                                    </a>
                                                </div>
                                                <div class="form-group city-delivery-settings <?= (isset($settings['city_wise_deliverability']) && $settings['city_wise_deliverability'] == true) ? 'd-block' : 'd-none' ?>;">
                                                    <label for="global_free_delivery_amount_on_city">Global Free Delivery Amount on City<span class='text-danger text-xs'>*</span></label>
                                                    <input type="text" class="form-control" id="global_free_delivery_amount_on_city" name="global_free_delivery_amount_on_city" value="<?= (isset($settings['global_free_delivery_amount_on_city'])) ? output_escaping($settings['global_free_delivery_amount_on_city']) : '' ?>" placeholder="Global Free Delivery Amount on City" />
                                                </div>
                                                <div class="form-group city-delivery-settings mt-2 <?= (isset($settings['city_wise_deliverability']) && $settings['city_wise_deliverability'] == true) ? 'd-block' : 'd-none' ?>;">
                                                    <label for="global_delivery_charge_on_city">Global Delivery Charge on City<span class='text-danger text-xs'>*</span></label>
                                                    <input type="text" class="form-control" id="global_delivery_charge_on_city" name="global_delivery_charge_on_city" value="<?= (isset($settings['global_delivery_charge_on_city'])) ? output_escaping($settings['global_delivery_charge_on_city']) : '' ?>" placeholder="Global delivery charge on City" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="form-group mt-4 d-flex justify-content-end gap-2">
                            ...
                            <button type="submit" class="btn btn-primary system_setting_form">Update Settings</button>
                        </div>
                </form>
                <!--/.col-md-12-->
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body ">
                                <ol>
                                    ...
                                    <li>Cron job will run every five minutes to check and activate/deactivate flash sales based on their scheduled time.</li>

                                    <li>Flash sales will automatically become active when the start time is reached and will be deactivated when the end time is reached.</li>

                                    <li>For example, if a flash sale is scheduled from 10:00 AM to 2:00 PM, the cron job will automatically activate it at 10:00 AM and deactivate it at 2:00 PM.</li>

                                    <li>Products included in an active flash sale will display the discounted price during the flash sale period.</li>

                                    <li>Make sure the cron job URL is set to run every 5 minutes: <code><?= base_url('admin/cron_job/fetch_active_flash_sale') ?></code></li>

                                    <li>If Flash Sale doesn't work, make sure cron job is set properly and is running every 5 minutes. If you don't know how to set cron job, please take help of server support or search for it.</li>
                                </ol>
                            </div>
                        </div>
                    </div>
