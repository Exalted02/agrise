            ...
            <div class="row">
                <form class="form-horizontal" action="<?= base_url('admin/product/add_product'); ?>" method="POST" enctype="multipart/form-data" id="save-product">
                    ...
                    <div class="col-md-12">
                                                ...
                                                <div class="card-body">
                                                    <div class="row">
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <select class="col-md-12 form-control" name="pro_input_tax[]" multiple id="multiple_tax">
                                                                <?php if (empty($taxes)) { ?>
                                                                    <option value="0" selected> No Taxes Are Added </option>
                                                                <?php } else { ?>
                                                                    <?php foreach ($taxes as $row) {
                                                                        $selected = '';
                                                                        if (isset($product_details[0]['tax']) && in_array($row['id'], explode(',', $product_details[0]['tax']))) {
                                                                            $selected = 'selected';
                                                                        }
                                                                    ?>
                                                ...
                                                <div class="card-body">
                                                    <div class="row">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-12 <?= (isset($product_details[0]['video_type']) && ($product_details[0]['video_type'] == 'youtube' ||  $product_details[0]['video_type'] == 'vimeo')) ? '' : 'd-none'; ?>" id="video_link_container">
                        ...
                        <div class="col-md-12  mt-4 product_qty  <?= (isset($product_details[0]['type']) && $product_details[0]['type'] == 'digital_product') ? 'd-none' : '' ?>">
                            <div class="row">
                                <div class=" mt-4 ">
                                    <div class="row">
                                        <div class="col-md-12 ">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group col-md-6 ">
                                                            <div class=" total_allowed_quantity <?= (isset($product_details[0]['type']) && $product_details[0]['type'] == 'digital_product') ? 'd-none' : '' ?>">
                                                                ...
                                                                <input type="number" min="1" class="col-md-12 form-control" id="total_allowed_quantity" name="total_allowed_quantity" value="<?= (isset($product_details[0]['total_allowed_quantity'])) ? $product_details[0]['total_allowed_quantity'] : '1'; ?>" placeholder='Total Allowed Quantity'>
                                                            </div>
                                                        </div>
                                                        <div class="form-group col-md-6 ">
                                                        ...
                                                        <div class="form-group col-md-6 ">
                                                            <div class="bulk_discount_min_qty <?= (isset($product_details[0]['type']) && $product_details[0]['type'] == 'digital_product') ? 'd-none' : '' ?>">
                                                                <label for="bulk_discount_min_qty" class="col-form-label">Min Qty for Bulk Discount</label>
                                                                <input type="number" class="col-md-12 form-control" id="bulk_discount_min_qty" name="bulk_discount_min_qty" min="0" value="<?= (isset($product_details[0]['bulk_discount_min_qty'])) ? $product_details[0]['bulk_discount_min_qty'] : 0; ?>" placeholder="Min quantity for bulk discount">
                                                            </div>
                                                        </div>
                                                        <div class="form-group col-md-6 ">
                                                            <div class="bulk_discount_amount <?= (isset($product_details[0]['type']) && $product_details[0]['type'] == 'digital_product') ? 'd-none' : '' ?>">
                                                                <label for="bulk_discount_amount" class="col-form-label">Bulk Discount Amount</label>
                                                                <input type="number" class="col-md-12 form-control" id="bulk_discount_amount" name="bulk_discount_amount" min="0" step="0.01" value="<?= (isset($product_details[0]['bulk_discount_amount'])) ? $product_details[0]['bulk_discount_amount'] : 0; ?>" placeholder="Fixed discount amount for bulk orders">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                        ...
                        <div class="col-md-12  mt-4 delivery_settings  <?= (isset($product_details[0]['type']) && $product_details[0]['type'] == 'digital_product') ? 'd-none' : '' ?>">
                            <div class="row">
                                <div class=" mt-4">
                                    <div class="row">
                                        <div class="col-md-12 ">
                                                        ...
                                                        ?>
                                                            <div class="col-12 row additional-info existing-additional-settings">
                                                                <div class="row mt-4 col-md-12 ">
                                                                    <nav class="w-100">
                                                                        <div class="nav nav-tabs product-variations" id="product-tab" role="tablist">
                                                                            <a class="nav-item nav-link active w-auto" id="tab-for-general-price" data-toggle="tab" href="#general-settings" role="tab" aria-controls="general-price" aria-selected="true">General</a>
                                                                            <a class="nav-item nav-link edit-product-attributes w-auto" id="tab-for-attributes" data-toggle="tab" href="#product-attributes" role="tab" aria-controls="product-attributes" aria-selected="false">Attributes</a>
                                                                ...
                                                                <div class="tab-content p-3 col-md-12" id="nav-tabContent">
                                                                    <div class="tab-pane fade active show" id="general-settings" role="tabpanel" aria-labelledby="general-settings-tab">
                                                                        <div class="form-group">
                                                                            <label for="type" class="col-md-12">Type Of Product :<span class='text-danger text-xs'>*</span></label>
                                                                        ...
                                                                        <div id='product-general-settings'>
                                                                            ...
                                                                            ?>
                                                                                <div id="general_price_section">
                                                                                    <div class="form-group">
                                                                                        <label for="type" class="col-md-2 mt-2">Price: <span class='text-danger text-xs'>*</span></label>
                                                                                        <div class="col-md-12 mt-2">
                                                                                            <input id="" type="number" name="simple_price" class="form-control stock-simple-mustfill-field price" value="<?= isset($product_variants[0]['price']) ?  $product_variants[0]['price'] : "" ?>" min='1' step="0.01">
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="form-group">
                                                                                        <label for="type" class="col-md-2 mt-2">Special Price: <span class='text-danger text-xs'>*</span></label>
                                                                                        <div class="col-md-12 mt-2">
                                                                                            <input id="" type="number" name="simple_special_price" class="form-control  discounted_price" value="<?= isset($product_variants[0]['special_price']) ?  $product_variants[0]['special_price'] : "" ?>" min='0' step="0.01">
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="form-group row mt-2 dimensions  
                                                                                        ...
                                                                                        <div class="col-3">
                                                                                            ...
                                                                                            <input type="number" class="form-control mt-2" min="0" name="weight" placeholder="Weight" id="weight" value="<?= (isset($product_variants[0]['weight']) && !empty($product_variants[0]['weight'])) ? $product_variants[0]['weight'] : "" ?>" step="0.01">
                                                                                        </div>
                                                                                        <div class="col-3">
                                                                                            <label for="height" class="control-label col-md-12">Height <small>(cms)</small> <span class='text-danger text-xs'>*</span></label>
                                                                                            <input type="number" class="form-control mt-2" min="0" name="height" placeholder="Height" id="height" value="<?= (isset($product_variants[0]['height']) && !empty($product_variants[0]['height'])) ? $product_variants[0]['height'] : "" ?>">
                                                                                        </div>
                                                                                        <div class="col-3">
                                                                                            <label for="breadth" class="control-label col-md-12">Breadth <small>(cms)</small> <span class='text-danger text-xs'>*</span></label>
                                                                                            <input type="number" class="form-control mt-2" min="0" name="breadth" placeholder="Breadth" id="breadth" value="<?= (isset($product_variants[0]['breadth']) && !empty($product_variants[0]['breadth'])) ? $product_variants[0]['breadth'] : "" ?>">
                                                                                        </div>
                                                                                        <div class="col-3">
                                                                                            <label for="length" class="control-label col-md-12">Length <small>(cms)</small> <span class='text-danger text-xs'>*</span></label>
                                                                                            <input type="number" class="form-control mt-2" min="0" name="length" placeholder="Length" id="length" value="<?= (isset($product_variants[0]['length']) && !empty($product_variants[0]['length'])) ? $product_variants[0]['length'] : "" ?>">
                                                                                        </div>
                                                                                    </div>
                                                                                ...
                                                                                <div class="form-group simple-product-level-stock-management <?= $HideStatus ?>">
                                                                                    <div class="col col-xs-12">
                                                                                        <label class="control-label mt-2">SKU :</label>
                                                                                        <input type="text" name="product_sku" class="col form-control simple-pro-sku mt-2" value="<?= (isset($product_details[0]['id']) && $product_details[0]['stock_type'] != NULL) ? $product_details[0]['sku'] : '' ?>">
                                                                                    </div>
                                                                                    <div class="col col-xs-12">
                                                                                        <label class="control-label mt-2">Total Stock :</label>
                                                                                        <input type="number" min="1" name="product_total_stock" class="col form-control stock-simple-mustfill-field mt-2" <?= (isset($product_details[0]['id']) && $product_details[0]['stock_type'] != NULL) ? ' value="' . $product_details[0]['stock'] . '" ' : '' ?>>
                                                                                        <label class="control-label mt-2">Stock Status :</label>
                                                                                        <select type="text" class="col form-control stock-simple-mustfill-field mt-2" id="simple_product_stock_status">
                                                                                    ...
                                                                                    <div class="form-group <?= (intval($product_details[0]['stock_type']) > 0) ? '' : 'collapse' ?>" id='stock_level'>
                                                                                        ...
                                                                                        <div class="col-md-12">
                                                                                            ...
                                                                                            <div class="form-group variant-product-level-stock-management <?= (intval($product_details[0]['stock_type']) == 1) ? '' : 'collapse' ?>">
                                                                                                <div class="col col-xs-12">
                                                                                                    <label class="control-label mt-2">SKU :</label>
                                                                                                    <input type="text" name="sku_variant_type" class="col form-control mt-2" value="<?= (intval($product_details[0]['stock_type']) == 1 && isset($product_variants[0]['id']) && !empty($product_variants[0]['sku'])) ? $product_variants[0]['sku'] : '' ?>">
                                                                                                </div>
                                                                                                <div class="col col-xs-12">
                                                                                                    <label class="control-label mt-2">Total Stock :</label>
                                                                                                    <input type="number" min="1" name="total_stock_variant_type" class="col form-control variant-stock-mustfill-field mt-2" value="<?= (intval($product_details[0]['stock_type']) == 1 && isset($product_variants[0]['id']) && !empty($product_variants[0]['stock'])) ? $product_variants[0]['stock'] : '' ?>">
                                                                                                </div>
                                                                                                <div class="col col-xs-12">
                                                                                                    <label class="control-label mt-2">Stock Status :</label>
                                                                                                    <select type="text" id="stock_status_variant_type" name="variant_status" class="col form-control variant-stock-mustfill-field mt-2">
                                                                    ...
                                                                    <div class="tab-pane fade" id="product-attributes" role="tabpanel" aria-labelledby="product-attributes-tab">
                                                                        ...
                                                                        <div class="col-md-12 d-flex justify-content-end">
                                                                            <a href="javascript:void(0);" id="save_attributes" class="btn btn-block btn-outline-primary float-right m-2  d-none">Save Attributes</a>
                                                                            <a href="javascript:void(0);" id="add_attributes" class="btn btn-block btn-outline-primary float-right m-2">Add Attributes</a>
                                                                        </div>
                                                                    ...
                                                                    <div class="col-12 row additional-info existing-additional-settings">
                                                                        <div class="row mt-4 col-md-12 ">
                                                                            <nav class="w-100">
                                                                                <div class="nav nav-tabs product-variations" id="product-tab" role="tablist">
                                                                                    <a class="nav-item nav-link active w-auto" id="tab-for-general-price" data-toggle="tab" href="#general-settings" role="tab" aria-controls="general-price" aria-selected="true">General</a>
                                                                                    <a class="nav-item nav-link disabled product-attributes w-auto" id="tab-for-attributes" data-toggle="tab" href="#product-attributes" role="tab" aria-controls="product-attributes" aria-selected="false">Attributes</a>
                                                                                    <a class="nav-item nav-link disabled product-variants d-none w-auto" id="tab-for-variations" data-toggle="tab" href="#product-variants" role="tab" aria-controls="product-variants" aria-selected="false">Variations</a>
                                                                                </div>
                                                                            </nav>
                                                                            <div class="tab-content p-3 col-md-12" id="nav-tabContent">
                                                                                <div class="tab-pane fade active show" id="general-settings" role="tabpanel" aria-labelledby="general-settings-tab">
                                                                                    ...
                                                                                    <div id="product-general-settings">
                                                                                        <div id="general_price_section" class="collapse">
                                                                                            <div class="form-group">
                                                                                                <label for="type" class="col-md-2 mt-2">Price:<span class='text-danger text-xs'>*</span></label>
                                                                                                <div class="col-md-12 mt-2">
                                                                                                    <input id="base_price" type="number" name="simple_price" class="form-control stock-simple-mustfill-field price base-price" min='1' step="0.01">
                                                                                                </div>
                                                                                            </div>
                                                                                            <div class="form-group">
                                                                                                <label for="type" class="col-md-2 mt-2">Special Price:<span class='text-danger text-xs'>*</span></label>
                                                                                                <div class="col-md-12 mt-2">
                                                                                                    <input id="special_price" type="number" name="simple_special_price" class="form-control discounted_price" min='0' step="0.01">
                                                                                                </div>
                                                                                            </div>

                                                                                            <div class="form-group row mt-2" id="product-dimensions">
                                                                                                <div class="col-3">
                                                                                                    <label for="weight" class="control-label col-md-12">Weight <small>(kg)</small> <span class='text-danger text-xs'>*</span></label>
                                                                                                    <input type="number" min="0" class="form-control mt-2" name="weight" placeholder="Weight" id="weight" value="" step="0.01">
                                                                                                </div>
                                                                                                <div class="col-3">
                                                                                                    <label for="height" class="control-label col-md-12">Height <small>(cms)</small> <span class='text-danger text-xs'>*</span></label>
                                                                                                    <input type="number" min="0" class="form-control mt-2" name="height" placeholder="Height" id="height" value="">
                                                                                                </div>
                                                                                                <div class="col-3">
                                                                                                    <label for="breadth" class="control-label col-md-12">Breadth <small>(cms)</small> <span class='text-danger text-xs'>*</span></label>
                                                                                                    <input type="number" min="0" class="form-control mt-2" name="breadth" placeholder="Breadth" id="breadth" value="">
                                                                                                </div>
                                                                                                <div class="col-3">
                                                                                                    <label for="length" class="control-label col-md-12">Length <small>(kg)</small> <span class='text-danger text-xs'>*</span></label>
                                                                                                    <input type="number" min="0" class="form-control mt-2" name="length" placeholder="Length" id="length" value="">
                                                                                                </div>
                                                                                            </div>
                                                                                        ...
                                                                                        <div class="form-group collapse simple-product-save">
                                                                                            <div class="col mt-2"> <a href="javascript:void(0);" class="btn btn-primary save-settings">Save Settings</a>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                    <div id="variant_stock_level" class="collapse">
                                                                                        ...
                                                                                        <div class="form-group">
                                                                                            <div class="col mt-2"> <a href="javascript:void(0);" class="btn btn-primary save-variant-general-settings">Save Settings</a>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                    <div id="digital_product_setting" class="collapse">
                                                                                        ...
                                                                                        <div class="row">
                                                                                            <div class="form-group mt-3 ml-2">
                                                                                                <div class="col mt-2"> <a href="javascript:void(0);" class="btn btn-primary save-digital-product-settings">Save Settings</a></div>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                ...
                                                                                <div class="tab-pane fade" id="product-variants" role="tabpanel" aria-labelledby="product-variants-tab">
                                                                                    <div class="col-md-12">
                                                                                        <a href="javascript:void(0);" id="reset_variants" class="btn btn-block btn-outline-primary float-right m-2 btn-sm">Reset Variants</a>
                                                                                    </div>
                                                                                    <div class="clearfix"></div>
                                                                                    <div class="form-group text-center row my-auto p-2 border rounded bg-gray-light col-md-12 no-variants-added">
                                                                                        <div class="col-md-12 text-center">No Product Variations Are Added !</div>
                                            ...
                                            <div class="col-md-12 ">
                                                <div class="card card-body">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="mb-3">
                                                                <textarea name="pro_input_description" class="textarea addr_editor" placeholder="Place some text here"><?= (isset($product_details[0]['description']) && !empty($product_details[0]['description'])) ? output_escaping(str_replace('\r\n', '&#13;&#10;', $product_details[0]['description'])) : ''; ?></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
