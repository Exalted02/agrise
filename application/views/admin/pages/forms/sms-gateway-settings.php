                                    ...
                                    <div class="">
                                        ...
                                        <form class="form-horizontal form-submit-event smsgateway_setting_form" action="<?= base_url('admin/Sms_gateway_settings/add_sms_data'); ?>" method="POST" id="smsgateway_setting_form" enctype="multipart/form-data">
                                            <div class="card-body">
                                                ...
                                                <div class="py-3">
                                                    <h4 class="mb-3">Create Authorization Token </h4><hr>
                                                ...
                                                <div class="">
                                                        ...
                                                        <div class="tab-pane fade active show" id="product-header" role="tabpanel" aria-labelledby="product-header-tab">
                                                            <div>
                                                                <div class="d-flex mb-4">
                                                                    <h6 class="modal-titlen  fw-bold">Add Header data</h6>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-12 description">
                                                                    <div class="form-group col-md-12">
                                                                        <div class="mb-3">
                                                                            <textarea name="text_format_data" class="text_format_data" rows="5" column="20" placeholder="Place some text here"></textarea>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="form-group ml-3">
                                                        ...
                                                        <button class="btn btn-success" id="sms_gateway_submit">Update SMS Gateway Settings</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
                                        ...
                                        <div class="modal-body">
                                            <ul>
                                                ...
                                                <div class="simplelightbox-gallery">
                                                    <a href="<?= base_url('assets/admin_old/images/base_url_and_params.png') ?>" target="_blank">
                                                ...
                                                <div class="simplelightbox-gallery">
                                                    <a href="<?= base_url('assets/admin_old/images/api_key_and_token.png') ?>" target="_blank">
                                                ...
                                                <div class="simplelightbox-gallery">
                                                    <a href="<?= base_url('assets/admin_old/images/sms_gateway_1.png') ?>" target="_blank">
                                                        <img src="<?= base_url('assets/admin/images/sms_gateway_1.png') ?>" class="w-100">
                                                    </a>
                                                </div>
                                                <div class="simplelightbox-gallery">
                                                    <a href="<?= base_url('assets/admin_old/images/sms_gateway_2.png') ?>" target="_blank">
