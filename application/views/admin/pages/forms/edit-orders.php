                    ...
                    <div class="card card-info">
                        <div class="card-body">
                            <table class="table">
                                    ...
                                    <td>
                                        ...
                                        ?>
                                            <div class="card col-md-3 col-sm-12 p-3 mb-2 bg-white rounded m-1 grow">
                                                    ...
                                                    <div class="row mb-1">
                                                        <div class="col-md-7">
                                                            ...
                                                            <?php if (empty($order_tracking_data[0]['shipment_id']) && $item['product_type'] != 'digital_product') { ?>
                                                                <input type="checkbox" class="check_create_order" id="<?php echo isset($pickup_location_name[0]['pickup_location']) ? $pickup_location_name[0]['pickup_location'] : ''; ?>"
                                                ...
                                                <div><span class="text-bold">Discounted Prices : </span> <?= $item['discounted_price'] ?> </div>
                                                ...
                                                <?php } ?>
                                                <div><span class="text-bold">Active Status : </span> <span class="badge badge-<?= $badges[$item['active_status']] ?>"> <small class="text-white active_class_badge"><?php print_r(str_replace('_', ' ', $item['active_status'])) ?></small></span></div>
                                                <div class="d-flex gap-3 mt-2">
                                                    <div><span class="text-bold">Attachment :</span></div>

                                                    <div class="order-product-image">
                                                        <a href=' <?= base_url() . $item['attachment'] ?>' data-toggle='lightbox' data-gallery='order-images'> <img src='<?= base_url() . $item['attachment'] ?>' class='h-75'></a>
                                                    </div>
                                                </div>
                                ...
                                <tr>
                                    <th class="w-10px">Platform Fees (<?= $settings['currency'] ?>)</th>
                                    <td><?php echo $order_detls[0]['platform_fees'];
                                        $total = ($total > 0) ? floatval($total - floatval($order_detls[0]['platform_fees'])) : $total; ?>
                                    </td>
                                </tr>
                                <?php
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" class="form-control" id="final_total" name="final_total" value="<?= str_replace('-', '', $order_detls[0]['total_payable']); ?>" disabled></td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select
                                            ...
                                            <?php if (isset($items[0]['product_type']) && $items[0]['product_type'] == 'digital_product') { ?>
                                                <option value="delivered" <?= (isset($item['active_status']) && strtolower($item['active_status']) == 'delivered') ? 'selected' : ''; ?>>
                                                    Delivered
                                                </option>
                                            <?php } else { ?>
                                    ...
                                    <div class="card-body pad">
                                        ...
                                        <div class="form-group row mt-4">
                                            <div class="col-3">
                                                ...
                                                <input type="number" class="form-control" name="parcel_weight" placeholder="Parcel Weight" id="parcel_weight" value="" step=".01" oninput="this.value = this.value < 0 ? '' : this.value">
                                            </div>
                                            <div class="col-3">
                                                <label for="parcel_height" class="control-label col-md-12">Height
                                                    <small>(cms)</small> <span class='text-danger text-xs'>*</span></label>
                                                <input type="number" class="form-control" name="parcel_height" placeholder="Parcel Height" id="parcel_height" value="" min="1" oninput="this.value = this.value < 0 ? '' : this.value">
                                            </div>
                                            <div class="col-3">
                                                <label for="parcel_breadth" class="control-label col-md-12">Breadth
                                                    <small>(cms)</small> <span class='text-danger text-xs'>*</span></label>
                                                <input type="number" class="form-control" name="parcel_breadth" placeholder="Parcel Breadth" id="parcel_breadth" value="" min="1" oninput="this.value = this.value < 0 ? '' : this.value">
                                            </div>
                                            <div class="col-3">
                                                <label for="parcel_length" class="control-label col-md-12">Length
                                                    <small>(cms)</small> <span class='text-danger text-xs'>*</span></label>
                                                <input type="number" class="form-control" name="parcel_length" placeholder="Parcel Length" id="parcel_length" value="" min="1" oninput="this.value = this.value < 0 ? '' : this.value">
                                            </div>
                                        </div>
                                    </div>
