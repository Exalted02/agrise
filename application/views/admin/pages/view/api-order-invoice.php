                  ...
                  <div class="row m-3 d-flex justify-content-between">
                     ...
                     <div class="col-md-4 invoice-col">
                        ...
                        <p>
                           ...
                           <strong>Mobile :</strong> <?= ($recipient_contact != "") ? $recipient_contact : $mobile; ?></strong><br>
                           ...
                           <tbody>
                              ...
                              ?>
                                 <tr>
                                    ...
                                    <td><?= $settings['currency'] . ' ' . number_format($row['price'] - $total_tax_for_row, 2) ?><br></td>
                                    <td>
                        ...
                        <div class="table-responsive">
                           <table class="table table-borderless">
                              <tbody>
                                 ...
                                 <?php if (isset($order_detls[0]['platform_fees']) && $order_detls[0]['platform_fees'] > 0) { ?>
                                    <tr>
                                       <th></th>
                                       <th>Platform Fees (
                                          <?= $settings['currency'] ?>)
                                       ...
                                       <td>+
                                          <?php $total += floatval($order_detls[0]['platform_fees']);
                                          echo $order_detls[0]['platform_fees']; ?>
                                       </td>
                                    </tr>
                                 <?php } ?>
                                 <tr>
                                 ...
                                 if (isset($order_detls[0]['discount']) && $order_detls[0]['discount'] > 0 && $order_detls[0]['discount'] != NULL) { ?>
                                    <tr>
                                       <th>Special Discount
                                          <?= $settings['currency'] ?>(<?= $order_detls[0]['discount'] ?> %)
                                       </th>
                                       <td>-
                                 ...
                                 <tr>
                                    ...
                                    <td>
                                       <?php $final_total = $final_sub_total - $order_detls[0]['discount'] - $order_detls[0]['promo_discount'] + $order_detls[0]['delivery_charge'] + (isset($order_detls[0]['platform_fees']) ? $order_detls[0]['platform_fees'] : 0); ?>
                                       <?= $final_total ?>
                                    </td>
                                 </tr>
                                 <tr>
                                 ...
                                 <?php
                                 if ($order_detls[0]['payment_method'] == "COD") {
                                 ?>
                                    <tr>


                                       <th></th>
                                       <th>Total Payable On COD (
                                          <?= $settings['currency'] ?>)
                                       </th>
                                       <td class="fw-bolder">
                                          <?= $order_detls[0]['total_payable'] ?>
                                       </td>
                                    </tr>
                                 <?php } ?>
                                 <!-- Continue with your HTML content if needed -->
                              </tbody>
                           </table>
                        </div>
                     </div>
