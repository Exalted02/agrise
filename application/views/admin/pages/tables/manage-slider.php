                            ...
                            <div class="card-body">
                                ...
                                <div id="type_add_html">
                                    ...
                                    <div class="form-group slider-brand <?= $hiddenStatus ?> ">
                                        ...
                                        <label for="brand_id"> Brands <span class='text-danger text-sm'>*</span></label>
                                ...
                                <div class="form-group mt-2">
                                    ...
                                    <button type="submit" class="btn btn-success slider_update" id="submit_btn"><?= (isset($fetched_data[0]['id'])) ? 'Update Slider' : 'Add Slider' ?></button>
                                </div>
