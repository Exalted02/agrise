                ...
                <div class="col-md-12 main-content">
                    <div class="card content-area p-4">
                        ...
                        <div class="card-innr">
                            <div class="row">
                                <div class="col-sm-3">
                                    <label for="category_parent" class="col-form-label fs-6">Filter By Product Category</label>
                                    ...
                                    <label for="product_type_filter" class="col-form-label fs-6">Filter Product By Type </label>
                                    <select id="product_type_filter" name="product_type_filter" placeholder="Select Type" required="" class="form-control">
