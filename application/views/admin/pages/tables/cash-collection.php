                                ...
                                <form class="form-horizontal form-submit-event" action="<?= base_url('admin/delivery_boys/manage-cash-collection'); ?>" method="POST" enctype="multipart/form-data">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row mt-2">
                                            <label for="name" class="col-sm-3 col-form-label">Amount to be Collect <span class='text-danger text-sm'>*</span></label>
                                            <div class="col-sm-9">
                                                <input type="text" name="amount" id="amount" class="form-control" onkeyup="validate_amount(this.value);">
                                            </div>
                                        </div>
                                        <div class="form-group row mt-2">
                                            <label for="name" class="col-sm-3 col-form-label">Date <small>(DD-MM-YYYY)</small><span class='text-danger text-sm'>*</span></label>
                                            <div class="col-sm-9">
