                        ...
                        <form class="form-horizontal form-submit-event" action="<?= base_url('admin/Featured_sections/add_featured_section'); ?>" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                <div class="form-group row">
                                    <label for="title" class="control-label mt-2">Title for section <span class='text-danger text-sm'>*</span></label>
                                    <div class="col-md-12">
                                        <input type="text" class="form-control mt-2" name="title" id="title" value="<?= (isset($fetched_data[0]['title']) ? stripslashes($fetched_data[0]['title']) : '') ?>" placeholder="Title">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="short_description" class="control-label mt-2">Short description <span class='text-danger text-sm'>*</span></label>
                                    <div class="col-md-12">
                                        <input type="text" class="form-control mt-2" name="short_description" id="short_description" value="<?= (isset($fetched_data[0]['short_description']) ? stripslashes($fetched_data[0]['short_description']) : '') ?>" placeholder="Short description">
                                    </div>
                                </div>
                                                                <div class="form-group row">
                                    <?php
                                    ...
                                    ?>
                                    <label for="product_type" class="control-label mt-2">Product Types <span class='text-danger text-sm'> * </span></label>
                                ...
                                <div class="form-group row">
                                    ...
                                    ?>
                                    <label for="style" class="control-label mt-2">Style <span class='text-danger text-sm'>*</span></label>
                                    <div class="col-md-12 mt-2">
                                ...
                                <div class="form-group row custom_products <?= (isset($fetched_data[0]['id'])  && $fetched_data[0]['product_type'] == 'custom_products') ? '' : 'd-none' ?>">
                                    <label for="product_ids" class="control-label">Products<span class='text-danger text-sm'> *</label>
                                    <div class="col-md-12">
                                ...
                                <div class="form-group row digital_products <?= (isset($fetched_data[0]['id'])  && $fetched_data[0]['product_type'] == 'digital_product') ? '' : 'd-none' ?>">
                                    <label for="digital_product_ids" class="control-label">Products <span class='text-danger text-sm'> *</label>
                                    <div class="col-md-12">
                                ...
                                <div class="form-group mt-4">
                                    ...
                                    <button type="submit" class="btn btn-success feature_sec_update m-1" id="submit_btn"><?= (isset($fetched_data[0]['id'])) ? 'Update Fetured Section' : 'Add Fetured Section' ?></button>
                                </div>
                            </div>
