            ...
            <div class="row">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row ">
                                    <div class="form-group">
                                        ...
                                        <button type="submit" class="btn btn-success mt-3 me-3" id="submit_btn"><?= (isset($fetched_data[0]['id'])) ? 'Update Zipcode' : 'Add Zipcode' ?></button>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-md-12 main-content mt-4">
                    <div class="card content-area p-4">
                        ...
                        <div class="card-innr">
                            <?php if (has_permissions('update', 'zipcodes')) { ?>
                                <div class="row mt-3">
                                    <div class="col-md-4">
