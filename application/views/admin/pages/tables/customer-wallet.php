                    ...
                    <div class="card card-info">
                        ...
                        <form class="form-horizontal form-submit-event" method="POST" action="<?= base_url('admin/customer/update_customer_wallet') ?>" enctype="multipart/form-data">
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <label for="type" class="col-sm-4 col-form-label mt-2">Select Type</label>
                                ...
                                <div class="form-group row">
                                    <label for="amount" class="col-sm-4 col-form-label mt-2">Amount <span class='text-danger text-sm'>*</span></label>
                                    <div class="col-sm-8">
                                        <input type="number" min="0" class="form-control mt-2" id="amount" placeholder="Enter Amount" name="amount">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="message" class="col-sm-4 col-form-label mt-2">Message <span class='text-danger text-sm'>*</span></label>
                                    <div class="col-sm-8">
                                        <textarea class="form-control mt-2" id="message" placeholder="Enter Message Here" name="message"></textarea>
                                    </div>
                                </div>
