...
class Transaction_model extends CI_Model
{
    ...
    function get_transactions_list($user_id = '')
    {
        ...
        if (isset($_GET['search']) and $_GET['search'] != '') {
            $search = $_GET['search'];
            $multipleWhere = ['`transactions.id`' => $search, '`transactions.amount`' => $search, '`transactions.date_created`' => $search, '`transactions.type`' => $search, '`transactions.order_id`' => $search, '`transactions.txn_id`' => $search, 'users.username' => $search, 'users.mobile' => $search, 'users.email' => $search, 'transactions.status' => $search];
        }
