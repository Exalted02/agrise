...
class Order_model extends CI_Model
{
    ...
    public function place_order($data)
    {
        ...
        if (!empty($product_variant)) {
            ...
            $final_total = $total + $delivery_charge + $platform_fees;
            ...
            send_mail($user_data[0]['email'], 'Place Order', 'Order Confirmation - ' . $system_settings['app_name'], $this->load->view('admin/pages/view/email-template.php', $overall_order_data, TRUE));
