...
class Setting_model extends CI_Model
{
    ...
    public function update_system_setting($post)
    {
        ...
        $system_data = [
            ...
            'platform_fees' => (isset($post['platform_fees']) && $post['platform_fees'] != '') ? $post['platform_fees'] : '0',
            ...
            'email_login' => (isset($post['email_login']) && !empty($post['email_login'])) ? 1 : 0,
            ...
            'admin_store_state' => (isset($post['admin_store_state']) && $post['admin_store_state'] != '') ? $post['admin_store_state'] : '',
            ...
            'global_free_delivery_amount_on_city' => (isset($post['global_free_delivery_amount_on_city'])) ? $post['global_free_delivery_amount_on_city'] : '',
            'global_delivery_charge_on_city' => (isset($post['global_delivery_charge_on_city'])) ? $post['global_delivery_charge_on_city'] : '',
            ...
            'min_cod_order_amount' => (isset($post['min_cod_order_amount']) && !empty($post['min_cod_order_amount'])) ? $post['min_cod_order_amount'] : '0',
            'max_cod_order_amount' => (isset($post['max_cod_order_amount']) && !empty($post['max_cod_order_amount'])) ? $post['max_cod_order_amount'] : '0',
        ];
    ...
    {
        $description = $post['about_us_input_description'];
        ...
        if ($count === 0) {
            ...
            $this->db->set('value', $description)->where('variable', 'about_us')->update('settings');
        }
    }
    ...
    public function update_service_account_file($post)
{
    ...
    // Convert array to JSON or string
    $value = is_array($post) ? json_encode($post) : $post;
