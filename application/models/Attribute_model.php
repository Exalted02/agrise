...
class Attribute_model extends CI_Model
{
    ...
    function get_attribute_set_list(
        ...
        foreach ($city_search_res as $row) {
            ...
            <a href="javascript:void(0)" class="edit_btn dropdown-item " title="Edit" data-id="' . $row['id'] . '" data-url="admin/attribute_set/" data-close-attribute-modal = "true"><i class="fa fa-pen"></i> Edit</a>';
    ...
    public function get_attribute_list($offset = 0, $limit = 10, $sort = 'id', $order = 'ASC')
    {
        $multipleWhere = '';
    ...
    public function get_attribute_values($offset = 0, $limit = 10, $sort = " id ", $order = 'ASC')
    {
        ...
        foreach ($city_search_res as $row) {
            ...
            <a href="javascript:void(0)" class="edit_btn dropdown-item" title="View" data-target="edit_attribute_modal" data-id="' . $row['id'] . '" data-url="admin/attribute_value/"><i class="fa fa-pen"></i>Edit</a>';
